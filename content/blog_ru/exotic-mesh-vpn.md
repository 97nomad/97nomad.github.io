...
Имеет шифрование на эллептических кривых, предлагает использовать свой PKI и выглядит в целом надёжненько.\
...
Под капотом используется свой собственный протокол поверх UDP, эллиптические кривые и тонну чёрной магии (к слову, нормально задокументированной), на которой это всё работает.
...
В качестве сервера использую [simple-http-server](https://github.com/TheWaWaR/simple-http-server), выставив количество потоков равное количеству ядер CPU. \
